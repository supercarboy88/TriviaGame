...
var questions = [{
    ...
    question:"2. What venue was once home for both the Mariners and the Seahawks?",
    answers:[" Kingdome ", " CenturyLink Field ", " KeyArena ", " T-Mobile Park "],
    correctAnswer:" Kingdome ",
},  {
    question:"3. Where does the University of Washington football team play its home games?",
    answers:[" Kingdome ", " CenturyLink Field ", " T-Mobile Park ", " Husky Stadium "],
    correctAnswer:" Husky Stadium ",
}, {
    question:"4. Who of the following played college basketball for the Washington Huskies?",
    answers:[" John Stockton ", " Marques Johnson ", " Harold Miner ", " Detlef Schrempf "],
    correctAnswer:" Detlef Schrempf ",
}, {
    question:"5. Who of the following was NEVER head coach of the Seattle Seahawks?",
    answers:[" Tom Flores ", " Chuck Knox ", " Jack Patera ", " Jim Lambright "],
    correctAnswer:" Jim Lambright ",
}, {
    question:"6. What number did former Seahawk star wide receiver Steve Largent wear?",
    answers:[" 78 ", " 80 ", " 82 ", " 85 "],
    correctAnswer:" 80 ",
}, {
    question:"7. Who of the following was NEVER a member of the Seattle Supersonics?",
...
function startGame (){
    ...
    $('#subwrapper').prepend('<h2>Time Remaining: <span id = "counter">32</span> Seconds</h2)');
    $('#start-game').remove();
